...
public class Picking_items extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.txt_header)).setText("Lectura de productos");
        ((Button)findViewById(R.id.btn_agregar_items)).setText("¿Terminaste?... Crear Caja");
            ...
            protected void onInventoryTag(RXInventoryTag tag) {
                ...
                new Thread(() -> {
                    ...
                    if(!main_list.contains(EPC)){
                        if(GlobalPreferences.FILTRO_ITEM.length() > 0){
                            List<String> items = Arrays.asList(GlobalPreferences.FILTRO_ITEM.split("\\s*,\\s*"));
    ...
    void update_recycler(){
        Picking_items.this.runOnUiThread(() -> {
